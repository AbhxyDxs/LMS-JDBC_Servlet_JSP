...
<body>
<h2 align="center">Delete using Book Id</h2>
	...
	<form action="bookServlet?action=delete&id=<%=b.getBookId()%>" method="post">
		<table align="center" border="0" width="25%" style="font-size: 18px">
			...
			<tr align="center">
				<td colspan="2" style="padding-top: 20px"> <input type="submit" value="Delete" style="padding: 5px 10px; font-size: 16px; margin-top: 10px; border-radius: 4px"></td>
			</tr>
		</table>
	</form>
	<%
